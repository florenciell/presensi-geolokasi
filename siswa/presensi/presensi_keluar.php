...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $tanggal_keluar = filter_input(INPUT_POST, 'tanggal_keluar', FILTER_SANITIZE_STRING);
    $jam_keluar = filter_input(INPUT_POST, 'jam_keluar', FILTER_SANITIZE_STRING);
...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="headline">Presensi Keluar</h2>
            <div id="mapContainer">
                <div id="map"></div>
            </div>
            <div class="button-wrapper">
                <form method="post">
                    ...
                    <input type="hidden" name="tanggal_keluar" value="<?= $current_date; ?>" readonly>
                    <input type="hidden" name="jam_keluar" value="<?= $current_time; ?>" readonly>
                    <button type="button" class="button-presensi" id="ambil-foto">
                        <i class="fas fa-camera icon"></i> Keluar
                    </button>
                </form>
            </div>
    ...
    <script>
        ...
        function takeSnapshot() {
            Webcam.snap(function(data_uri) {
                ...
                params.append('tanggal_keluar', document.querySelector('input[name="tanggal_keluar"]').value);
                params.append('jam_keluar', document.querySelector('input[name="jam_keluar"]').value);

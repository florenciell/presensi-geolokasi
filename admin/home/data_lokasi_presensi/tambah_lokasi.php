...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nama_lokasi) && !empty($alamat_lokasi) && !empty($latitude) && !empty($longitude) && !empty($radius) && !empty($zona_waktu) && !empty($jam_masuk) && !empty($jam_pulang)) {
        // Siapkan query SQL
        $sql = "INSERT INTO lokasi_presensi (nama_lokasi, alamat_lokasi, latitude, longitude, radius, zona_waktu, jam_masuk, jam_pulang) 
                VALUES ('$nama_lokasi', '$alamat_lokasi', '$latitude', '$longitude', '$radius', '$zona_waktu', '$jam_masuk', '$jam_pulang')";
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Tambah Lokasi Presensi</h4><br>
                                <form class="forms-sample" method="POST" action="">
                                    <div class="form-group">
                                        <label for="nama_lokasi">Nama Lokasi</label>
                                        <input type="text" class="form-control" id="nama_lokasi" name="nama_lokasi" placeholder="Masukan Lokasi">
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat_lokasi">Alamat Lokasi</label>
                                        <input type="text" class="form-control" id="alamat_lokasi" name="alamat_lokasi" placeholder="Masukan alamat">
                                    </div>
                                    <div class="form-group">
                                        <label for="latitude">Latitude</label>
                                        <input type="text" class="form-control" id="latitude" name="latitude" placeholder="Masukan Latitude">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="radius" name="radius" placeholder="Masukan Radius">
                                    </div>
                                    <div class="form-group">
                                        <label for="keterangan">Zona Waktu</label>

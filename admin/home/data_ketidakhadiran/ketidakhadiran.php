...
// Ambil data ketidakhadiran dari database
$query = "SELECT k.id, s.nama, kl.kelas AS kelas, k.keterangan
...
if ($filterDate) {
    $query .= " WHERE k.dari = '$filterDate'"; // Pastikan 'tanggal' adalah kolom yang tepat
}
                ...
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">
                            ...
                            </span> Data Ketidakhadiran
                        </h3>
                        <form action="" method="GET" class="d-flex align-items-center">
                            <input type="date" name="filterDate" class="form-control rounded me-2"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h4 class="card-title mb-0">Ketidakhadiran</h4>
                                        <button type="button" class="btn btn-primary btn-sm" style="min-width: 150px;" onclick="window.location.href='tambah_ketidakhadiran.php'">
                                                    ...
                                                    echo "<td>
                                                            <div class='dropdown'>
                                                                ...
                                                                <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                                                    <li><a class='dropdown-item' href='detail_ketidakhadiran.php?id=" . $row['id'] . "'>Detail</a></li>
                                                                    <li><a class='dropdown-item' href='edit_ketidakhadiran.php?id=" . $row['id'] . "'>Edit</a></li>
                                                                    <li><a class='dropdown-item' href='delete_ketidakhadiran.php?id=" . $row['id'] . "' onclick='return confirm(\"Yakin ingin menghapus data ini?\")'>Delete</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>";
                                                    echo "</tr>";

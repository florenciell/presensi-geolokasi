...
include_once '../../../config.php'; // Sesuaikan path dengan struktur direktori Anda

// Fetch all students with their respective classes
$sql = "SELECT siswa.id, siswa.nama, siswa.nisn, siswa.jenis_kelamin, kelas.kelas
        FROM siswa
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <!-- Judul Kartu -->
                                        <h4 class="card-title mb-0">Siswa</h4>
                                        <!-- Tombol Tambah Data -->
                                        <button type="button" class="btn btn-primary btn-sm" style="min-width: 150px;" onclick="window.location.href='tambah_siswa.php'">
                                        ...
                                        <tbody>
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td>" . $row['kelas'] . "</td>"; // Menampilkan nama kelas dari tabel 'kelas'
                                                    echo "<td>
                                                    <div class='dropdown'>
                                                        <button class='btn btn-secondary btn-sm' type='button' id='dropdownMenuButton" . $row['id'] . "' data-bs-toggle='dropdown' aria-expanded='false' style='background: none; border: none;'>
                                                            <i class='mdi mdi-dots-vertical' style='color: gray; font-size: 1.2rem;'></i>
                                                        </button>
                                                        <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton" . $row['id'] . "'>
                                                            <li><a class='dropdown-item' href='detail_siswa.php?id=" . $row['id'] . "'>Detail</a></li>
                                                            <li><a class='dropdown-item' href='edit_siswa.php?id=" . $row['id'] . "'>Edit</a></li>
                                                            <li><a class='dropdown-item' href='hapus_siswa.php?id=" . $row['id'] . "' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\");'>Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>";
